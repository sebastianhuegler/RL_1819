...
\begin{figure*}[!thp] 
	...
	\end{subfigure}\caption{Figures (a)-(c) show the improvement process while }\label{fig:PoWER}
\end{figure*} 
...
\subsection{Results}
In the following the results of the three systemss mass-spring-damper, pendulum and cart-pole are shown.\\\\
\textit{Mass-spring-damper:}
\\
\\
\textit{Pendulum:}\\
\textit{Cart-Pole:}\\
